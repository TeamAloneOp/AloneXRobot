...
@AloneX.on_message(filters.command("unpinall") & ~filters.private)
...
@AloneX.on_message(filters.command("antichannelpin") & ~filters.private)
...
@AloneX.on_message(filters.command("cleanlinked") & ~filters.private)
...
@AloneX.on_message(filters.command("permapin") & ~filters.private)
...
@AloneX.on_message(filters.linked_channel)
