...
from Alone import DRAGONS, LOGGER, TIGERS, WOLVES
from Alone.modules.helper_funcs.chat_status import user_not_admin
...
from Alone.modules.sql import reporting_sql as sql
...
@Alonecmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@Alonemsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@Alonecallback(pattern=r"report_")
